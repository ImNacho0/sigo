...
export const mockVulnerabilityData: VulnerabilityData[] = [
    {
        ...
        leakDetails: 'Censos electorales del INE de 2011, 2018 y 2022, complementados con bases del padrón municipal. Datos de identidad, domicilio y filiación de decenas de millones de ciudadanos.',
