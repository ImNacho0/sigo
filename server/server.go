...
func main() {
	...
	mux.HandleFunc("/api/searchcan", handleSearchCan)
	mux.HandleFunc("/api/searchbol", handleSearchBol)
	mux.HandleFunc("/api/searchecu", handleSearchEcu)
	mux.HandleFunc("/api/searchven", handleSearchVen)
	mux.HandleFunc("/api/searchpar", handleSearchPar)
	mux.HandleFunc("/api/searchmex", handleSearchMex)
	mux.HandleFunc("/api/searchcenso", handleSearchCenso)
